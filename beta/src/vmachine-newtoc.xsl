...
<xsl:stylesheet version="1.1" exclude-result-prefixes="tei"
   ...
   <xsl:variable name="vmLogo">../vm-images/walden-fluid-text-edition-logo.gif</xsl:variable>
   ...
   <xsl:template name="mainControls">
      <div id="mainControls">
       ...
       &nbsp; &nbsp;&#160; &#160;
         ...
         <input type="button" id="newPanel" alt="New Version" onclick="openPanel();" />
         <!-- &nbsp; &nbsp;-->&#160; &#160;
         <input type="button" id="bibToggle" alt="Bibliographic Info" onclick="toggleBiblio();" />
         <!-- &nbsp; &nbsp;-->&#160; &#160;
         <input type="button" id="helpToggle"  alt="Help Viewer" onclick="toggleHelp();" />
         <!-- &nbsp; &nbsp;-->&#160; &#160;
         <select id="notesMenu">
            <xsl:choose>
      ...
      <div class="panel" id="bibPanel">
        <!--  <xsl:if test="$displayBibInfo != 'true'">
         ...
         <div class="panelBanner">
            ...
            Table of Contents/Bibliographic Information
         </div>
