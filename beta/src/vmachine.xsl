...
<!--    <xsl:output method="html" version="4.01" encoding="utf-8" indent="yes" doctype-system="http://www.w3.org/TR/html4/strict.dtd" doctype-public="-//W3C//DTD HTML 4.01//EN" /> -->
 <xsl:output method="html" doctype-system="about:legacy-compat"/>  
   <!--
     ...
     * 2014-06-26 by Leah M Root: rebuilt mainBanner and mainControls templates with new javascript controls and icons. Suppressed bibPanel template. Dropdown menus for TOC and Key replaces the bibPanel.                          
   -->
   ...
   <xsl:variable name="vmLogo">../vm-images/walden-fluid-text-edition-logo.png</xsl:variable>
  ...
  "true" to "false" below -->
   ...
   <xsl:template name="brandingLogo">
      <div id="brandingLogo"> 
         <img id="logo" alt="Walden: A Fluid Text Edition - Powered by the Versioning Machine">
            <xsl:attribute name="src">
               <xsl:value-of select="$vmLogo" />
            </xsl:attribute>
         </img>
         <a href="http://v-machine.org"><img id="poweredby" alt="Powered by the Versioning Machine" src="../vm-images/poweredbyVM.png"></img></a>
      </div>
   </xsl:template>
   
   <xsl:template name="headline">
      <!-- div id="headline">
         <h1 onclick="toggle_visibility('tocContent');">
            <xsl:value-of select="$truncatedTitle" />
         </h1>
   ...
   <!-- end div brandingLogo -->
   <xsl:template name="mainControls">
      <div id="mainControls">
         
         <!-- New Panel -->
        <a class="newPanel" href="#" onclick="openPanel();"><img src="../vm-images/addVersion.png" alt="Add Version"></img></a>
         <!--Show/Hide Notes -->
         <a href="javascript: void(0)" id="notesMenu_popup" onClick="notesFormatToggle('popup')" style="display:none;"><img src="../vm-images/toggleNotes.png" alt="Show/Hide Notes"></img></a><a href="javascript: void(0)" id="notesMenu_none" onClick="notesFormatToggle('none')"><img src="../vm-images/toggleNotes.png" alt="Show/Hide Notes"></img></a>
        ...
        <!-- <select id="notesMenu">
         ...
         <!--Table of Contents -->	   
         <a class="toggleTOC" href="#" alt="Table of Contents" onclick="toggle_visibility('tocContent');"><img id="toggleTOC" src="../vm-images/toggleTOC.png"></img></a>
         <div id="tocContent"><img class="closePanel" onclick="this.parentNode.style.display = 'none';" src="../vm-images/closePanel.gif" alt="X" />
            <ul class="dropdown">
               <!--             <li><h4><xsl:value-of select="$fullTitle" /></h4></li> -->
               ...
               <li><span><a href="01.html">1. Economy</a></span></li>
               <li><span><a href="02.html">2. Where I Lived</a></span></li>
               <li><span><a href="03.html">3. Reading</a></span></li>
               <li><span><a href="04.html">4. Sounds</a></span></li>
               <li><span><a href="05.html">5. Solitude</a></span></li>
               <li><span><a href="06.html">6. Visitors</a></span></li>
               <li><span><a href="07.html">7. Bean Field</a></span></li>
               <li><span><a href="08.html">8. Village</a></span></li>
               <li><span><a href="09.html">9. Ponds</a></span></li>
               <li><span><a href="10.html">10. Baker Farm</a></span></li>
               <li><span><a href="11.html">11. Higher Laws</a></span></li>
               <li><span><a href="12.html">12. Brute Neighbors</a></span></li>
               <li><span><a href="13.html">13. House-Warming</a></span></li>
               <li><span><a href="14.html">14. Inhabitants</a></span></li>
               <li><span><a href="15.html">15. Winter Animals</a></span></li>
               <li><span><a href="16.html">16. Pond In Winter</a></span></li>
               <li><span><a href="17.html">17. Spring</a></span></li>
               <li><span><a href="18.html">18. Conclusion</a></span></li>
            </ul>  
         </div>
        <!--end div tocContent -->
   
         <!-- Help -->
         <a class="toggleHelp" href="#" alt="Help" onclick="toggle_visibility('helpContent');"><img id="toggleHelp" src="../vm-images/toggleHelp.png"></img></a>
         <div id="helpContent"> <img class="closePanel" onclick="this.parentNode.style.display = 'none';" src="../vm-images/closePanel.gif" alt="X" />
            <ul class="dropdown">
               <li><h4>Key</h4></li>
               <p><span class="key-black"><strong>Black</strong></span>  =  Unchanged text through the Princeton Ed.</p>
               <p><span class="key-gray"><strong>Gray background</strong></span>  =  inferred text (interpolated, not in apparatus)</p>
               <p><span class="key-red"><strong>Red</strong></span>  =  supplied text (interpolated, not in manuscripts)</p>
               <p><span class="key-green"><strong>Green</strong></span>  =  interlined in ink.</p>
               <p><span class="key-olive"><strong>Olive</strong></span>  =  interlined in pencil.</p>
               <p><span class="key-strikethrough"><strong>Strikethrough</strong></span>  =  cancelled text.</p>
               <p><br/></p>
               <li> <h4>List of Versions</h4></li>
...
<!--               <p><strong>Princeton_Ed:</strong> Princeton Ed. of Walden</p>
               <p><strong>Version_A:</strong> Walden, Version A (1847)</p>
               <p><strong>Version_B:</strong> Walden, Version B (1849)</p>
               <p><strong>Version_C:</strong> Walden, Version C (1849)</p>
               <p><strong>Version_D:</strong> Walden, Version D (1852)</p>
               <p><strong>Version_E:</strong> Walden, Version E (late 1852 - 1853)</p>
               <p><strong>Version_F:</strong> Walden, Version F (1853-1854)</p>
               <p><strong>Version_G:</strong> Walden, Version G (1854)</p>
               <p><br/></p>-->
               
               <li><h4><a href="http://goo.gl/rlNn64" target="_blank">Report an Issue</a></h4></li>
               <p><br/></p>
               
               <li><h4>Publication Details:</h4></li>
            ...
            </div><!--end div helpContent -->
         <a class="userGuide" alt="User Guide" href="http://www.digitalthoreau.org/fluid-text/guide/"><img id="userGuide" src="../vm-images/userGuide.png"></img></a>
         <a class="returnProjectPage" alt="Return to FluidText Project Page" href="http://www.digitalthoreau.org/fluid-text/"><img id="returnProjectPage" src="../vm-images/returnProjectPage.png"></img></a>
         </div><!-- end div mainControls -->
   </xsl:template><!-- end template mainControls -->
